...
class EstateDatasource {
  ...
  Future<CategoryServiceModel> getAllCategories() async {
    final result = GetApi(
      uri: ApiVariabels().getCategories(),
      fromJson: categoryServiceModelFromJson,
    );
  ...
  Future<EstateDetailsResponseModel> getEstateDetails(int houseId) async {
    ...
    final result = GetApi<EstateDetailsResponseModel>(
        ...
        fromJson: estateDetailsResponseModelFromJson
        //  (body) {
