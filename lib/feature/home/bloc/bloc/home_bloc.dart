...
class HomeBloc extends Bloc<HomeEvent, HomeState> {
  HomeBloc({required HomeDatasource homeDatasource}) : super(HomeState()) {
    on<GetTrendingEvent>((event, emit) async {
      ...
      result.fold(
          (l) => emit(state.copyWith(trendingHousesStatus: ApiStatus.failed)),
          (r) => emit(
                state.copyWith(
                  trendingHousesStatus: ApiStatus.success,
